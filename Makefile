...
RDA_CMD_C_SOURCES = rda_cmd.c tty.c protocol.c packet.c dump.c mtdparts_parser.c crc32.c file_mmap.c fullfw.c prog_dir.c
RDA_MKFW_C_SOURCES = rda_mkfw.c file_mmap.c dump.c fullfw.c prog_dir.c
